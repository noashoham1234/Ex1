...
public class Ex1Main {
    ...
    public static void main(String[] args) {
        ...
        while (!num1.equals(quit) && !num2.equals(quit)) {
            ...
            System.out.println("Enter a base for output (or \"quit\" to end the program): (a number [2,16])");
            String firstBase = sc.next();
            int base = Ex1.convertBaseStringToNum(firstBase);
            ...
            if (firstBase.equals("quit")) {
                break;
            } else if (!Ex1.checkIfValidBase(base)) {
                System.out.println("ERR: wrong base, should be [2,16], got (" + firstBase + ")");
            } else {
